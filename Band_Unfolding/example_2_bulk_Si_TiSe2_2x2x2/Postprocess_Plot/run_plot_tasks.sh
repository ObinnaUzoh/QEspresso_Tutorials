...
#unfolding_task_args="${unfolding_task_args} -efermi 7.9172 -emin -13 -emax 6 -dE 0.050"
plot_task_args='-input_file unfolded_EBS_symmetry-averaged.dat --show --save -cmap Greys'
plot_task_args="${plot_task_args} -emin -5.5 -emax 2 -vmin 0 -vmax 0.001 -plotdir plot --round_cb 0 -ar 4/4 --cb_label_full -interp nearest"
# -cmap gist_earth -vmin 0 -vmax 0.001  --n_levels 80 -res l -ar 4/4 -fmt tiff --cb_label_full -interp nearest
